...
# Read manually cleaned data
## NOTE THAT THE ENCODING MAY HAVE TO BE CHANGED FOR THIS TO WORK.
manually_cleaned = pd.read_csv('data/cleansed/mistress_latest.csv', encoding='latin-1', low_memory=False,
